// Removemos a constante TWBS_DOCS_URL porque não vamos mais usar as URLs dos guias
// const TWBS_DOCS_URL = "https://getbootstrap.com/docs/5.3";

// Também removemos a constante GUIDES porque ela contém os dados que não serão mais exibidos
/*
const GUIDES = [
  {
...
const AppGuides: React.FC = () => {
  return (
    <>
      ...
      */}
      {/* Comentamos a renderização da lista GUIDES */}
      {/*
      {GUIDES.map((guide) => {
        return (
